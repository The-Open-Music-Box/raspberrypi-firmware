...
class TestPlaylistService:
    ...
    # Note: Folder rename tests removed after UUID migration - playlists now use UUID-based immutable folders
    # Previously tested: title change triggers folder rename, error handling during rename, track path updates
    ...
    # Note: test_cleanup_playlist_folder_fallback_to_id removed - UUID-based folders make this test obsolete
