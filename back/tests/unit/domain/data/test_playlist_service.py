...
class TestPlaylistService:
    ...
    @pytest.mark.skip(reason="Folder rename feature removed - playlists now use UUID-based folders")
    @pytest.mark.asyncio
    async def test_update_playlist_with_title_change_triggers_folder_rename(self, service, mock_playlist_repo, mock_track_repo, tmp_path, monkeypatch):
        """Test that updating playlist title triggers folder rename. [OBSOLETE - UUID migration]"""
    ...
    @pytest.mark.skip(reason="UUID migration - folder operations simplified")
    @pytest.mark.asyncio
